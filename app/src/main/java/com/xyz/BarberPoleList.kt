...
class BarberPoleList : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        relativeLayout {
            ...
            val poleAd: PoleAdapter = PoleAdapter(lv)
            lv.adapter = poleAd
...
class PoleAdapter(val listView: ListView) : BaseAdapter() {
    val li = MutableList<Int>(10, { Random().nextInt(100) })

    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        return with(listView.context) {
